...
3.Resize the browser window to simulate different screen sizes and resolutions.
4.Use the browser's developer tools to inspect and modify the website's code.